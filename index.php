    ...
    <body>
        ...
        <section class="section-cities" id="cities">
            ...
            <div class="row js--wp-3">
                <div class="col span-1-of-4 box">
                    <img src="vendors/img/orange-county.jpg" alt="Orange County">
                    <h3>Orange County</h3>
                    ...
                    <div class="city-feature">
                        ...
                        <a href="#">@omnifood_oc</a>
                    </div>
                </div>
                <div class="col span-1-of-4 box">
                    <img src="vendors/img/los-angeles.jpg" alt="Los Angeles">
                    <h3>Los Angeles</h3>
                    <div class="city-feature">
                        <i class="ion-ios-person icon-small"></i>
                        1200+ happy eaters
                    ...
                    <div class="city-feature">
                        <i class="ion-social-twitter icon-small"></i>
                        <a href="#">@omnifood_la</a>
                    </div>
                </div>
                <div class="col span-1-of-4 box">
                    <img src="vendors/img/cupertino.jpg" alt="Cupertino">
                    <h3>Cupertino</h3>
                    <div class="city-feature">
                        <i class="ion-ios-person icon-small"></i>
                        2300+ happy eaters
        ...
        <section class="section-testimonials">
            ...
            <div class="row">
                ...
                <div class="col span-1-of-3">
                    <blockquote>
                       Inexpensive, healthy and great-tasting meals, delivered right to my home. We have lots of food delivery here in Orange County, but no one comes even close to Omifood. Me and my family are so in love!
...
I was looking for a quick and easy food delivery service in San Franciso. I tried a lot of them and ended up with Omnifood. Best food delivery service in the Bay Area. Keep up the great work!
        ...
        <div class="map-box">
            ...
            <div class="form-box" id="form">
                ...
                <div class="row">
                    <form method="post" action="mailor.php" class="contact-form">
                        <div class="row">
